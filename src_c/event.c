    ...
    switch (event->type) {
        ...
        case SDL_JOYAXISMOTION:
            ...
            _pg_insobj(dict, "instance_id",
                       PyInt_FromLong(event->jaxis.which));
        ...
        case SDL_JOYBALLMOTION:
            _pg_insobj(dict, "joy", _joy_map_instance(event->jaxis.which));
            _pg_insobj(dict, "instance_id",
                       PyInt_FromLong(event->jball.which));
        ...
        case SDL_JOYBUTTONDOWN:
            _pg_insobj(dict, "joy", _joy_map_instance(event->jaxis.which));
            _pg_insobj(dict, "instance_id",
                       PyInt_FromLong(event->jbutton.which));
        ...
        case SDL_AUDIODEVICEREMOVED:
            ...
            _pg_insobj(dict, "iscapture",
                       PyInt_FromLong(event->adevice.iscapture));
            break;
#endif /* SDL2_AUDIODEVICE_SUPPORTED */
        case SDL_FINGERMOTION:
        case SDL_FINGERDOWN:
        ...
        case SDL_MULTIGESTURE:
            ...
            _pg_insobj(dict, "num_fingers",
                       PyInt_FromLong(event->mgesture.numFingers));
            break;
        case SDL_MOUSEWHEEL:
